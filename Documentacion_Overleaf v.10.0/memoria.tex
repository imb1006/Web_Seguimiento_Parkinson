...
\begin{abstract}
Motor issues characteristic of Parkinson's Disease (PD) significantly affect gait function, causing freezing of gait episodes in the most critical stages. This has a great impact on the quality of life of people with PD.

The monitoring devices available for this disease are expensive and scarce, and even fewer focus on analyzing gait parameters. The collection and analysis of this data are essential to provide the objective information that allows professionals to make informed decisions regarding treatment modification and therapy adaptation.

Continuing with a previous project, whose goal was to provide a support tool in the clinical field and help for patients, small improvements have been made to the hardware of the device used for data recording, and a website has been developed. This advancement has enabled wireless operation of the device through the use of Bluetooth for communication with the web server. Data transmission occurs in real-time, allowing its display from a simple interface that also facilitates the management of data collection. The innovation of the web platform consists of allowing both professionals and patients to easily access the most relevant information.
