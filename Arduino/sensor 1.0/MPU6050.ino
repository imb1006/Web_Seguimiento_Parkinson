...
float cont_espera = 0;    // tiempo de espera entre un paso y el siguiente
...
void contarPasos()
{
  // Funcion que lee los valores del acelerometro y contabiliza los pasos realizados.
    ...
    // si la pierna izquierda esta hacia delante
    if ((ay * accEscala) >= 0.5) { 
...
void setup()
{
  ...
  // Introducir el sexo
  Serial.print("Introduce el sexo del paciente (hombre/mujer): ");
  delay(3000);
...
void loop()
{
  ...
  if (digitalRead(8) == HIGH){
    ...
    tiempo1 = millis()/1000; // inicializar el tiempo
